...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{samlav.in}
      {Created my website from scratch using Apache2, Bootstrap, and lots of HTML, CSS, and JS.}
    \resumeSubItem{Mailbox Sensor}
      {Read data from a motion sensor in a mailbox with Arduino and sent that data to a Raspberry Pi that displayed text on a small OLED display and sent text messages about the mail.
}
    \resumeSubItem{Robotic Marble Sorter}
      {Used C to program a machine that sorted between clear, colored, wood, and metal marbles.}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
	\resumeSubHeadingListStart
    	\item{
      		\textbf{Languages}{: C, Java, Python, PHP, JavaScript}
      		\hfill
      		\textbf{Frameworks}{: Zend Framework 2, Bootstrap}
    	}
  	\resumeSubHeadingListEnd
